...
Disabled Registration
    ...
    Input Text    id=sign-up__first-name    Danyil
    Input Text    id=sign-up__last-name    Bubenshchykov
...
Login
    ...
    Input Text    id=sign-in__email    danbuben2000@gmail.com

    Wait Until Element Is Visible    id=sign-in__password
    Input Password    id=sign-in__password   10052000Dan!
...
Successful Registration
    ...
    Input Text    id=sign-up__first-name    Danyil
    Input Text    id=sign-up__last-name    Bubenshchykov
    Input Text    id=sign-up__email    danbuben2000@gmail.com

    Input Password    id=sign-up__password    10052000Dan!
    Input Password    id=sign-up__confirm-password    10052000Dan!
